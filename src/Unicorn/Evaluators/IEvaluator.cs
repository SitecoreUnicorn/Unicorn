...
namespace Unicorn.Evaluators
{
	...
	public interface IEvaluator
	{
		...
		void EvaluateOrphans(ISerializableItem[] orphanItems);
		...
		ISerializableItem EvaluateNewSerializedItem(ISerializableItem newItem);
		...
		ISerializableItem EvaluateUpdate(ISerializableItem serializedItem, ISerializableItem existingItem);
	}
}
