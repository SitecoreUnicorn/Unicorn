...
namespace Unicorn.ControlPanel
{
	...
	public class ControlOptions : IControlPanelControl
	{
		...
		public void Render(HtmlTextWriter writer)
		{
			...
			writer.Write("<a class=\"button\" href=\"?verb=Sync&amp;configuration={0}\">Sync {1} Now</a>", encodedConfigurationName, configurationName);
			...
			writer.Write("<a class=\"button\" href=\"?verb=Reserialize&amp;configuration={0}\" onclick=\"return confirm('This will reset the serialized state to match Sitecore. This normally is not needed after initial setup unless changing path configuration. Continue?')\">Reserialize {1} Now</a>", encodedConfigurationName, configurationName);
		}
	}
}
