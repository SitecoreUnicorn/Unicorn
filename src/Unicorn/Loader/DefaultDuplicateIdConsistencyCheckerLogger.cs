...
namespace Unicorn.Loader
{
	public class DefaultDuplicateIdConsistencyCheckerLogger : IDuplicateIdConsistencyCheckerLogger
	{
		...
		public virtual void DuplicateFound(string existingItemDisplayText, IItemData duplicateItem)
		{
			
		}

		public void DuplicateFound(DuplicateIdConsistencyChecker.DuplicateIdEntry existingItemData, IItemData duplicateItemData)
		{
